...
export const CEFR_LEVEL_DETAILS: Record<CEFRCode, CEFRLevelDetails> = {
  A1: {
    ...
    vocabulary: "~700 most frequent lemmas, concrete nouns, simple common verbs",
    forbidden: [
      "NO perfect tenses",
      "NO modal + perfect combinations (may have, could have, should have, must have)",
      "NO conditionals",
      "NO relative clauses",
      "NO abstract nouns",
      "NO passive voice",
      "NO infinitive complements (learned to, wanted to, tried to) — restructure as two simple clauses",
    ],
    allowed: [
      "Simple present tense",
      "Simple past tense for narration — stories are naturally told in past tense",
      "Simple future forms — keep basic",
      "Simple modals: can, want, need, must (present tense only)",
      "Basic compound sentences",
      "Simple dialogue (breaks up narration naturally)",
      "Pronouns after subject is clearly established",
      "Basic emotions: happy, sad, scared, surprised, angry",
    ],
    connectors: [],  // Connectors handled via writing guidelines — language-neutral
    styleGuidance: [
  ...
  A2: {
    ...
    vocabulary: "1,000 most common words, common abstract nouns okay (idea, problem, time)",
    forbidden: [
      "NO present perfect",
      "NO past perfect",
      "NO passive voice",
    ...
    allowed: [
      ...
      "Simple present tense",
      "Simple future forms",
      "Compound sentences with basic conjunctions",
      "Basic subordinate clauses (because, when, before, after)",
    ...
    styleGuidance: [
      ...
      "Show irony through contrast (character thought X, but Y happened)",
      "Show motivation through cause-effect (character wanted X, so did Y)",
  ...
  B1: {
    ...
    vocabulary: "2,500 words, common idioms and expressions, abstract vocabulary acceptable",
    forbidden: [
      "NO past perfect — unless essential for clarity",
