...
tour: {
  ...
  browseAllStories: "Explorar todas las historias",
  storyLandingIntro: "Hola, somos Cuentana. La idea es simple y respaldada por décadas de investigación en adquisición de lenguas: aprende un idioma leyendo y escuchando historias que realmente disfrutas. El truco está en encontrarte en tu nivel — y crecer contigo.",
  storyLandingSubtagline: "Cada historia está adaptada a cinco niveles de dominio, para que puedas leer a tu nivel hoy y avanzar al siguiente. Traducción integrada, audio palabra por palabra y modo bilingüe te ayudan a aprender por contexto — y seguimos tu progreso mientras lees.",
  readStoryByName: 'Leer "{title}"',
  newBadge: "Nuevo",
  rightsPublicDomain: "El texto original es de dominio público. Esta adaptación educativa © Cuentana.",
  rightsLicensed: "Esta obra se utiliza bajo licencia. Esta adaptación educativa © Cuentana.",
  rightsOriginal: "Contenido original © Cuentana.",
  readStory: "Léeme",
  readMore: "Leer más",
  readLess: "Leer menos",
...
onboarding: {
  ...
  createAccountBenefit1: "Premium gratis para los primeros usuarios — cupos limitados",
  createAccountBenefit2: "Escucha audiolibros completos a tu nivel",
  createAccountBenefit3: "Sube cualquier texto y léelo a tu nivel",
  createAccountBenefit4: "Guarda palabras, ponte a prueba, construye una lista personal",
  createAccountCta: "Crear cuenta gratis",
...
myStories: {
  ...
  waiting: "Esperando",
  storyTooShort: "La historia es muy corta. Por favor proporciona al menos 20 palabras.",
  ...
  fileExceedsLimit: "El archivo excede el límite de palabras. Por favor usa un archivo más corto.",
  ...
  firstStoryBonus: "Primera historia del mes: hasta {max} palabras gratis.",
  freeTierLimit: "Límite gratuito: {max} palabras.",
  ...
  storyExceedsLimit: "La historia excede el límite de {max} palabras.",
  freeTier: "Gratis",
...
audioPlayer: {
  ...
  cached: "Listo",
  requiresGeneration: "Requiere generación",
  startGenerating: "Empezar a generar",
  variantStandard: "Estándar",
  variantSlow: "Lento",
  variantStandardBilingual: "Estándar EN + ES",
  variantSlowBilingual: "Lento EN + ES",
  variantStandardDesc: "Velocidad normal, solo inglés",
  variantSlowDesc: "Velocidad 0.7x, solo inglés",
  variantStandardBilingualDesc: "Velocidad normal, inglés + español",
  variantSlowBilingualDesc: "Velocidad 0.7x, inglés + español",
  generationInFlightElsewhere: "Otro capítulo se está generando. Espera o cancélalo primero.",
},
};
