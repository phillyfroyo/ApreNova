...
stories: {
  ...
  storyLandingIntro: "Hi there, we're Cuentana. The idea is simple and backed by decades of language-acquisition research: learn a language by reading and listening to stories you actually enjoy. The trick is meeting you at your level — and growing with you.",
  storyLandingSubtagline: "Every story is adapted to five proficiency levels, so you can read at your level today and grow into the next. Built-in translation, word-by-word audio, and a bilingual mode help you learn through context — and we track your progress as you go.",
  readStoryByName: 'Read "{title}"',
  newBadge: "New",
