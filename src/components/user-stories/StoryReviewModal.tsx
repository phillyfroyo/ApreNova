                  ...
                  {completedStreams.length > 0 && (
                    <div className="relative" ref={previewDropdownRef}>
                      ...
                      >
                        ...
                        <svg className={`w-3 h-3 transition-transform ${showPreviewDropdown ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                        </svg>
                      </button>
                      {/* Dropdown - click to toggle */}
                      {showPreviewDropdown && (
                        <div className="absolute right-0 top-full mt-1 w-56 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-10">
                          <div className="py-1">
