// src/components/StoryLayoutExperimental.tsx
"use client";
...
export default function StoryLayoutExperimental({
  ...
  useEffect(() => {
    const handleGlobalClick = (e: MouseEvent) => {
      ...
      // EXCEPT for our specific audio/translation control buttons
      if (
      ...
      // 2. If any translation is active, allow audio controls but prevent emoji toggle
      const hasActiveTranslations = Object.values(activeTranslations).some(Boolean);
      if (hasActiveTranslations) {
        // Allow audio controls and related buttons to work when translation is open
        if (
          ...
          // Let these clicks through to their handlers
          return;
        }
        // Block everything else (including emoji toggle) when translation is active
        return;
      }
    ...
    >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Dropdown
              ...
              onSelect={(selectedValue) => {
                ...
                // Navigate to sandbox page in experimental mode
                router.push(`/sandbox/experimental/page-${selectedPage}`);
              }}
              onOpenChange={(isOpen) => {
            ...
            <Dropdown
              ...
              onSelect={(selectedValue) => {
                if (selectedValue === "normal") {
                  router.push(`/sandbox/page-${pageNumber}`);
                }
                // Stay in experimental if experimental selected
              }}
              onOpenChange={(isOpen) => {
            ...
            <div className="flex flex-col items-center space-y-4 mt-8">
              <div className="flex space-x-4">
                <a
                  ...
                  href={
                    prev
                      ? `/sandbox/experimental/page-${prev.pg}`
                      : undefined
                  }
                ...
                <a
                  ...
                  href={
                    next
                      ? `/sandbox/experimental/page-${next.pg}`
                      : undefined
                  }
      ...
      <div className="flex justify-center mt-16 sm:mt-28 max-w-7xl mx-auto gap-10 flex-wrap lg:flex-nowrap relative">
        ...
        <div className="flex flex-col items-start w-full max-w-md sm:max-w-lg mx-auto px-4">
          <h1 className="text-2xl sm:text-3xl font-bold text-center w-full">{title} (Experimental)</h1>
